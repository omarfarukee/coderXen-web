...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg border border-red-500 bg-background p-10 md:shadow-xl",
        className,
      )}
      ref={containerRef}
    >
...
const Icons = {
  ...
  user: () => (
    ...
    // </svg>
    <img className="" src="https://upload.wikimedia.org/wikipedia/commons/e/ef/Youtube_logo.png" alt="" />
  ),
};
